  ...
  <div class="ContentDiv">
      ...
      <div class="Panel RightPanel" >
        <div v-if="viewmode == 0">
          <table class="TableDefault">
            ...
            <tr class="addRowButton">
              <td colspan="9"><button @click="AddRowRequest(catalogJson[0])" class="BlockWithIcon"><img src="../../assets/add.png" alt="" class="icon">Добавить заявку</button></td>
              <td v-if="systemStatus.typeWorkplace in {3:null,4:null}"></td>
              <td><button v-if="requestJson.length > 0" @click="LoadXLSX" class="LoadExel"><img src="../../assets/excel.png"><span>&#8203;</span></button></td>
            </tr>   
          </tbody></table>
        </div>
        ...
        <tbody><tr v-for="data, index in catalogJson"
          ...
          <tr class="addRowButton">
            <td colspan="6"><button @click="AddRow" class="BlockWithIcon"><img src="../../assets/add.png" alt="" class="icon">Добавить</button></td>
          </tr> 
        </tbody></table>
      </div>
      ...
      <div v-if="viewmode == 2">
        <table class="TableDefault">
          ...
          <tr class="addRowButton">
            <td colspan="7"><button @click="CreateNewdatarequest" class="BlockWithIcon"><img src="../../assets/add.png" alt="" class="icon">Добавить</button></td>
          </tr> 
          </tbody></table>
      </div>
